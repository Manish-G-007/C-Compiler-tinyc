...
%union{
    ...
    string *strval; //to hold the value of string literals
...
%token BREAK CASE CHAR CONST CONTINUE DEFAULT DO DOUBLE ELSE EXTERN FLOAT FOR GOTO IF INLINE INT LONG REGISTER RESTRICT RETURN SHORT SIZEOF STATIC STRUCT SWITCH TYPEDEF UNION VOID VOLATILE WHILE
